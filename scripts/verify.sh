...
check "404 page exists"                     "body '/404' | grep -qi 'nothing planted'"
...
check "history.md points at git history"    "body '/$ARTICLE/history.md' | grep -q 'commits/main/drafts'"
...
check "sibling link renders as clean URL"   "body '/$ARTICLE' | grep -q 'href=\"/tending-over-publishing\"'"
check "backlinks section is present"        "body '/tending-over-publishing' | grep -q 'Linked from'"
